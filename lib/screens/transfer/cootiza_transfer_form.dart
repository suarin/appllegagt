...
class CooitzaTransferForm extends StatefulWidget {
  const CooitzaTransferForm({Key? key}) : super(key: key);

  @override
  _CooitzaTransferFormState createState() => _CooitzaTransferFormState();
}

class _CooitzaTransferFormState extends State<CooitzaTransferForm> {
  //Variables
  ...
  _executeTransaction(BuildContext context) async {
    ...
    await TransferServices.getCooitzaTransfer(
            _passwordController.text,
            _destinationCardController.text,
            _amountController.text,
            _notesController.text)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transferencia GTM'),
