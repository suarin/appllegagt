...
class RegistrationResultsScreen extends StatefulWidget {
  ...
  const RegistrationResultsScreen({Key? key, @required this.registrationSuccessResponse}) : super(key: key);

  @override
  _RegistrationResultsScreenState createState() => _RegistrationResultsScreenState(registrationSuccessResponse: this.registrationSuccessResponse);
}

class _RegistrationResultsScreenState extends State<RegistrationResultsScreen> {
  final RegistrationSuccessResponse? registrationSuccessResponse;
  _RegistrationResultsScreenState({Key? key, @required this.registrationSuccessResponse});
  ...
  final _gtText = '\nAL FINALIZAR EL REGISTRO NO PODRAS INGRESAR A TU CUENTA, HASTA QUE ENVÍES COPIA DE LOS SIGUIENTES DOCUMENTOS:\n'
      ...
      '2. RECIBO DE SERVICIOS QUE DEMUESTRE TU DIRECCION, ENVIALOS AL WHATSAPP, NUMERO 502 2221 4775.\n'
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              SizedBox(
                                child: Text( isUS ? _usText: _gtText,
