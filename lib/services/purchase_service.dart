...
class PurchaseService{
  ...
  static Future<dynamic> getQrPay(
    ...
    //Prepare Uri
    var url = Uri.parse('${baseUrl + ApiResources.qrPayUri}?ReqMerchantID=$merchantId&ReqToken=$token&ReqMMerchantID=$reqMMerchantID&ReqCHolderID=$reqCHolderID&ReqCPwd=$reqCPwd&ReqStrTotal=$reqStrTotal');
    //Send card transfer
  ...
  static Future<dynamic> getVirtualTransactions(
    ...
    var baseUrl = await getBaseUrl();
    //Prepare Uri
    var url = Uri.parse('${baseUrl + ApiResources.virtualCardTransactionsUri}?ReqMerchantID=$merchantId&ReqToken=$token&ReqVirtualCardNo=$reqVirtualCardNo&ReqEndDate=$reqEndDate');
    //Send card transfer
    http.Response response;
    try{
      response = await http.get(
  ...
  static Future<dynamic> getVisaTransactions(
    ...
    var baseUrl = await getBaseUrl();
    //Prepare Uri
    var url = Uri.parse('${baseUrl + ApiResources.visaCardTransactionsUri}?ReqMerchantID=$merchantId&ReqToken=$token&ReqVisaCardNo=$reqVisaCardNo&ReqEndDate=$reqEndDate');
    //Send card transfer
    http.Response response;
    try{
      response = await http.get(
